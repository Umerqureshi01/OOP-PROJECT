...
public:
    ...
    void addFlight() {
        ...
        if (choice == 1) {
            flights.push_back(make_unique<DomesticFlight>(fn, o, d, dt, seats));
        } else if (choice == 2) {
            cout << "Visa/Entry Fee: ";
            cin >> fee;
            flights.push_back(make_unique<InternationalFlight>(fn, o, d, dt, seats, fee));
        } else if (choice == 3) {
            cout << "Contract Holder Name: ";
            cin >> ws;
            getline(cin, contract);
            flights.push_back(make_unique<CharterFlight>(fn, o, d, dt, seats, contract));
        } else { 
    ...
    void registerPassenger() {
        ...
        if (choice == 1) passengers.push_back(make_unique<EconomyPassenger>(name, id));
        else if (choice == 2) passengers.push_back(make_unique<BusinessPassenger>(name, id));
        else if (choice == 3) passengers.push_back(make_unique<FirstClassPassenger>(name, id));
    ...
    void bookTicket() {
        ...
        try {
            ...
            tickets.push_back(make_unique<Ticket>(f, p, seatNum, fare));
    ...
    void loadFromFile() {
        flights.push_back(make_unique<DomesticFlight>("D101", "NYC", "LAX", "2023-12-01 10:00", 100));
        flights.push_back(make_unique<InternationalFlight>("I202", "JFK", "LHR", "2023-12-02 18:00", 200, 50.0));
        passengers.push_back(make_unique<EconomyPassenger>("John_Doe", "p001"));
        passengers.push_back(make_unique<BusinessPassenger>("Jane_Smith", "p002"));
